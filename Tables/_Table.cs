...
namespace Database.SouthAfricanCensus.Tables
{
	...
	{
		public static void Log(this StreamWriter streamwriter, _Table _table)
		{
			streamwriter.WriteLine("Pk: {0}", _table.Pk);
		}
		public static void LogError(this StreamWriter streamwriter, _Table _table)
		{ }
	}
}